...
const Navbar = () => {
  return (
    <div>
      <header className="header sticky top-0 bg-slate-50  flex items-center justify-between px-8 py-02">
        <h1 className="w-3/12">
          <Link to="">
            <svg
              viewBox="0 0 248 31"
              className="h-6 w-auto hover:text-blue-500 duration-200"
            >
              <path
